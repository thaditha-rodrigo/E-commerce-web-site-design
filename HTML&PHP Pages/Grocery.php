...
<title>Grocery</title>
	...
	<style>
		...
		*, *:before, *:after {
		...
		.hero-image{
			background-image: url("images/grocery-back2.jpg");
		}
...
?>
	...
	<div class="after-menu">
	 ...
	 $sql = "SELECT * , `price` - (`price`*`discount`) AS disc_price FROM `product` WHERE `category` = 'grocery';";
			...
			<div class="column">
				<div class="card" onClick="location.href='item.php?id=<?php echo $row["pro_id"];?>'">
						  ...
						  <?php
							if( (isset($_SESSION["username"])) || (isset($_SESSION["admin_id"])) )
							{
							 ...
							 <div class="add-to-wishlist">
								 <a href="addToWishlistManagerGrocery.php?id=<?php echo $row["pro_id"];?>"><img src="images/favorite.png" style="width:35px;height: 35px;"></a>
							 </div>
					   	   <?php
							}
					   	   ?>
					...
					<?php
						...
						{
					?>
							<p><button name="cart"><a href="addToCartManagerGrocery.php?id=<?php echo $row["pro_id"];?>">Add to Cart</a></button></p>
					<?php
						}
					?>
					</form>
